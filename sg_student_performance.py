...
print("="*60)
print("CLASIFICACIÓN STUDENT PERFORMANCE CON STACKED GENERALIZATION")
print("="*60)
...
try:
    y_pred_proba = best_stacking.predict_proba(X_test_scaled)
...
try:
    ...
    meta_features = None
    print("\nNota: No se pudieron generar meta-características")
...
fig.suptitle('Evaluación del Stacked Generalization - Student Performance', fontsize=14, fontweight='bold')
...
# Visualización de meta-características (si están disponibles)
