...
print("="*60)
print("CLASIFICACIÓN STUDENT PERFORMANCE CON VOTING CLASSIFIER")
print("="*60)
...
try:
    y_pred_proba = best_voting.predict_proba(X_test_scaled)
...
fig.suptitle('Evaluación del Voting Classifier - Student Performance', fontsize=14, fontweight='bold')
